...
static int app_is_number(int c) { return isdigit(c); }
static int app_is_lower(int c) { return islower(c); }
static int app_is_upper(int c) { return isupper(c); }
static int app_is_symbolic(int c) { return isprint(c); }

static void app_set_use_char(app_t* app, const char* str, UseType type)
{
	char* app_use_char;
